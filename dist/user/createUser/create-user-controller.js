    ...
    execute(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield user_1.createUserSchema.parseAsync(params);
                const createdUser = yield this.createUserUseCase.execute(params);
                ...
                if (error instanceof errors_1.EmailAlreadyExists) {
                    return (0, http_1.badRequest)({ message: error.message });
                }
                console.log(error);
