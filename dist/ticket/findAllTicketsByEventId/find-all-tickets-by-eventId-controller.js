...
exports.FindAllTicketsByEventIdController = void 0;
const http_1 = require("@/erros/http");
const event_1 = require("@/schemas/event");
const zod_1 = require("zod");
class FindAllTicketsByEventIdController {
    constructor(findAllTicketsByEventIdUseCase) {
    ...
    execute(httpParams) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const tickets = yield this.findAllTicketsByEventIdUseCase.execute(eventId);
...
exports.FindAllTicketsByEventIdController = FindAllTicketsByEventIdController;
