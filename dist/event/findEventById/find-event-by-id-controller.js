...
exports.FindEventByIdController = void 0;
...
class FindEventByIdController {
    constructor(findEventByIdUseCase) {
    ...
    execute(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const event = yield this.findEventByIdUseCase.execute(eventId);
                if (!event) {
...
exports.FindEventByIdController = FindEventByIdController;
