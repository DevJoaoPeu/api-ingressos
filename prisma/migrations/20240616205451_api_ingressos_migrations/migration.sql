...
-- AddForeignKey
ALTER TABLE "controllerTicket" ADD CONSTRAINT "controllerTicket_eventId_fkey" FOREIGN KEY ("eventId") REFERENCES "event"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
